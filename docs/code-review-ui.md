...
### Phase 1: Core Flow
- [ ] Review button in change timeline
- [ ] Main panel view with loading state
- [ ] Stream summary and comments
- [ ] Basic comment list UI

### Phase 2: Interactions
- [ ] View in diff (scroll + highlight)
- [ ] Pin to chat functionality
- [ ] Dismiss comments
- [ ] Filter by severity
