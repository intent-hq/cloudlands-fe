...
test('renders all 32 diagram cases together without the dense review shell', async ({ page }) => {
  ...
  await expect(page.locator('[data-diagram-case] .mermaid-renderer')).toHaveCount(17);
