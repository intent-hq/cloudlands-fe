 ...
 * `type` is a string, `fromAgentId` is a non-empty string, or
 * `source === 'system'`. Every daemon-origin entry — agent-to-agent sends,
 * event-notification wakes, hook wakes, PR-monitor wakes,
 * `questions_dismissed`, `source: 'system'` — stays hidden.
 */
