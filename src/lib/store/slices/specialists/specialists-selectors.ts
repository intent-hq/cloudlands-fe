...
const logger = createLogger("SpecialistsSelectors");

// ============================================================================
// Basic state selectors
// ============================================================================

export const selectBundledSpecialists = createSelector(
  (state): Specialist[] => state.specialists.bundledSpecialists
);

export const selectCustomSpecialists = createSelector(
  (state): CustomSpecialist[] => state.specialists.customSpecialists
);

export const selectFileSpecialists = createSelector(
  (state): FileSpecialist[] => state.specialists.fileSpecialists
);

export const selectUserOverrides = createSelector(
  (state): SpecialistOverrides => state.specialists.userOverrides
);

export const selectOverridesLoaded = createSelector(
  (state): boolean => state.specialists.overridesLoaded
);

export const selectCustomSpecialistsLoaded = createSelector(
  (state): boolean => state.specialists.customSpecialistsLoaded
);

export const selectFileSpecialistsLoaded = createSelector(
  (state): boolean => state.specialists.fileSpecialistsLoaded
);

export const selectBundledSpecialistsLoaded = createSelector(
  (state): boolean => state.specialists.bundledSpecialistsLoaded
);

export const selectSpecialistsFolderPath = createSelector(
  (state): string | null => state.specialists.specialistsFolderPath
);

export const selectProviderModelOverrides = createSelector(
 ...
 */
export const selectIsSpecialistVisible = createSelector(
 ...
 */
export function filterSpecialistsByGitHubAuth(
...
export const selectSpecialists = createSelector(
  (state): Specialist[] => {
    const fileSpecialists = state.specialists.fileSpecialists;
    const bundledSpecialists = state.specialists.bundledSpecialists;
    const customSpecialists = state.specialists.customSpecialists;
...
export const selectSpecialistById = createSelector(
  (state, specialistId: string): {
    id: string;
    name: string;
    description: string;
    source: 'file' | 'builtin' | 'custom';
  } | null => {
    const file = state.specialists.fileSpecialists.find((s: FileSpecialist) => s.id === specialistId);
    if (file) {
    ...
    const custom = state.specialists.customSpecialists.find((s: CustomSpecialist) => s.id === specialistId);
    if (custom) {
...
export const selectSpecialistName = createSelector(
  (state, specialistId: string): string | null => {
...
export const selectResolvedDefaultModel = createSelector(
  (state, specialistId: string, providerId?: string): string => {
    const specialists = selectSpecialists.select(state);
    const specialist = specialists.find((s: Specialist) => s.id === specialistId);
    if (!specialist) return '';
...
export const selectEffectiveBehaviorPrompt = createSelector(
  (state, specialistId: string): string => {
    const specialists = selectSpecialists.select(state);
    const specialist = specialists.find((s: Specialist) => s.id === specialistId);
    if (!specialist) return '';
...
export const selectIsBuiltIn = createSelector(
  (state, specialistId: string): boolean => {
...
export const selectIsFileBased = createSelector(
  (state, specialistId: string): boolean => {
    return state.specialists.fileSpecialists.some((s: FileSpecialist) => s.id === specialistId);
  }
);
...
export const selectGetFileSpecialist = createSelector(
  (state, specialistId: string): FileSpecialist | undefined => {
    return state.specialists.fileSpecialists.find((s: FileSpecialist) => s.id === specialistId);
  }
);

/** Get the on-disk file path for a specialist */
export const selectSpecialistFilePath = createSelector(
...
export const selectResolvedDefaultCodingAgent = createSelector(
  (state, specialistId: string): string => {
    const specialists = selectSpecialists.select(state);
    const specialist = specialists.find((s: Specialist) => s.id === specialistId);
