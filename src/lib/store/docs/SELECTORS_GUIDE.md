...
- `.agents/skills/svelte-redux-toolkit/selectors/SKILL.md`
- `.agents/skills/svelte-redux-toolkit/selector-lifecycle/SKILL.md`
- `.agents/skills/svelte-redux-toolkit/selector-channels/SKILL.md`
...
App-local selectors should be created from the configured app Store so state inference follows `src/lib/store/reducer.ts`.

```typescript
import { store } from "$lib/store/store";
import { getItem, getItems } from "svelte-redux-toolkit/utils/collections/collection-utils";
...
- `src/lib/store/AGENTS.md` for selector lifecycle and component boundary rules.
