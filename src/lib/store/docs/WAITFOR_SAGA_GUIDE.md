...
This project guide is a concise companion to `.agents/skills/svelte-redux-toolkit/waitFor/SKILL.md`. The skill is the active source of truth for signature, edge cases, and implementation details.
...
- `.agents/skills/svelte-redux-toolkit/waitFor/SKILL.md`
- `.agents/skills/svelte-redux-toolkit/sagas/SKILL.md`
