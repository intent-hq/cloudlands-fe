...
<div
  class="discussion-request-notice flex items-start gap-2.5 px-3 py-2.5 my-2 rounded-md bg-warning/10 border border-warning/30 text-warning-ink {className}"
