...
<Button
  ...
  class="pointer-events-auto block h-auto min-h-9 w-full min-w-0 shrink whitespace-normal border-0 px-3! py-2! text-left font-normal {surface ===
  'subscription'
    ? SUBSCRIPTION_CARD_SURFACE_CLASS
    : USER_MESSAGE_SURFACE_CLASS} focus-visible:ring-2"
