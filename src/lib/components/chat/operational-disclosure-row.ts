...
export const OPERATIONAL_ROW_LINE_CLASS =
...
export const COMPACT_TOOL_ROW_CLASS =
  'relative grid min-h-5 w-full min-w-0 max-w-full grid-cols-[1rem_minmax(0,1fr)_auto] items-center gap-1.5 overflow-hidden py-0';

export const COMPACT_TOOL_ICON_BOX_CLASS = `a11y-ignore flex h-5 w-4 min-w-4 items-center justify-center ${OPERATIONAL_SECONDARY_CLASS}`;
