...
export const MESSAGE_ACTION_SURFACE_CLASS =
  'message-actions flex max-w-full items-center gap-0.5 rounded-md border border-border bg-sidebar p-0 text-foreground transition-opacity motion-reduce:transition-none';
