...
export const MESSAGE_ACTION_SURFACE_CLASS =
  'message-actions pointer-events-none flex max-w-full items-center gap-0.5 rounded-md border border-border bg-sidebar p-0 text-foreground transition-opacity motion-reduce:transition-none';

export const MESSAGE_ACTION_REVEAL_CLASS =
  'opacity-0 group-hover:opacity-100 group-focus-within:opacity-100';

export const MESSAGE_ACTION_TIME_CLASS =
  'type-caption pointer-events-none min-w-0 select-none break-words pl-1.5 pr-1 tabular-nums text-muted-foreground';
