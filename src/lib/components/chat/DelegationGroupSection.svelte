...
>
  <div class={SUBSCRIPTION_DISCLOSURE_ROW_CLASS} data-testid="delegation-group-header">
    <button
      type="button"
      class="min-w-0 flex-1 cursor-pointer rounded border-none bg-transparent p-0 text-left font-[inherit] text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring {SUBSCRIPTION_LEADING_CONTENT_CLASS}"
