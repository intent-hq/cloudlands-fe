...
<button
  ...
  style="width: var(--control-height-large); height: var(--control-height-large); bottom: max(var(--space-2), env(safe-area-inset-bottom, 0px)); right: max(var(--space-2), env(safe-area-inset-right, 0px));"
