...
<div
  class="group/launcher relative flex min-w-0 w-full cursor-pointer items-center overflow-hidden rounded-lg border border-border bg-card px-3 py-2 text-foreground transition-colors"
