...
export { default as FilesPanel } from './FilesPanel.svelte';
export { default as CodeChangesPanel } from './CodeChangesPanel.svelte';
...
export { default as SidebarActivityPanel } from './SidebarActivityPanel.svelte';
