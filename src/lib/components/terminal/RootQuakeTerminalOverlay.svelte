      ...
      >
        <div class="flex items-center h-full min-w-0 overflow-x-auto scrollbar-none">
          ...
          {#each terminals as term (term.id)}
            ...
            <div
              class={cn(
                'flex items-center gap-1.5 h-full px-2.5 text-sm font-medium text-muted-foreground cursor-pointer transition-all duration-150 min-w-0 max-w-90 whitespace-nowrap border-x border-border/50 -ml-px group/tab',
