    ...
    <div class="mention-display">
      ...
      {#if showMenu}
        <div class="mention-wrapper">
          <EnhancedMentionList items={filteredItems} command={handleCommand} />
        </div>
      {:else}
