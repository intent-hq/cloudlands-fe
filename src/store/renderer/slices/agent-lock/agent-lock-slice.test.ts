...
import { agentLockReducer, initialState, setAgentLockState } from './agent-lock-slice';
...
describe('agent-lock-slice reducer', () => {
  ...
  it('handles multiple workspaces independently', () => {
    let state = agentLockReducer(initialState, setAgentLockState('ws-1', { 'agent-1': true }, {}));
