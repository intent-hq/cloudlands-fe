...
describe('externalEditorsReducer', () => {
  ...
  describe('setOpenAction', () => {
    ...
    it('should coerce malformed selected actions to a string', () => {
      const state = externalEditorsReducer(initialState, setOpenAction(123 as unknown as string));
  ...
  describe('fetchEditorsSuccess', () => {
    it('should set editors and lastFetched', () => {
      ...
      const state = externalEditorsReducer(initialState, fetchEditorsSuccess(editors, timestamp));

      expect(state.editors).toEqual(createCollection<InstalledEditor, 'id'>('id', editors));
    ...
    it('should clear error on success', () => {
      ...
      const state = externalEditorsReducer(prev, fetchEditorsSuccess([mockEditor], 999));
    ...
    it('should not mutate previous state', () => {
      const state = externalEditorsReducer(initialState, fetchEditorsSuccess([mockEditor], 100));

      expect(initialState.editors).toEqual(createCollection<InstalledEditor, 'id'>('id'));
  ...
  describe('fetchEditorsFailure', () => {
    it('should set error and clear loading', () => {
      ...
      const state = externalEditorsReducer(prev, fetchEditorsFailure('Network error'));
