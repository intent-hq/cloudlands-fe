...
/** ids of the backends with an open operation currently in flight. */
export const selectOpeningConnectionIds = store.createSelector(
  (state) => state.connections.openingIds,
);
