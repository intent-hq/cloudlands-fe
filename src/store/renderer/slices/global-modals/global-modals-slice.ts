...
globalModalsReducer.with(closeGitHubAuthModal, (state) => ({
  ...state,
  githubAuth: {
    ...state.githubAuth,
    open: false,
...
globalModalsReducer.with(openGitCredentialsModal, (state, { payload: [error] }) => ({
  ...state,
  gitCredentials: {
...
globalModalsReducer.with(closeGitCredentialsModal, (state) => ({
  ...state,
  gitCredentials: {
    ...state.gitCredentials,
    open: false,
