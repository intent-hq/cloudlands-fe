...
export const selectStatsPeriodKey = store.createSelector((state) => state.stats.periodKey);

export const selectStatsLoading = store.createSelector((state) => state.stats.loading);
