...
export const loadUsageStatsRequested = createAction<
  [mode: UsageStatsPeriod, key: string | null, tzOffsetMinutes: number]
>('stats/loadUsageStatsRequested');

export const usageStatsLoaded =
  createAction<[mode: UsageStatsPeriod, key: string | null, data: UsageStatsResult]>(
    'stats/usageStatsLoaded',
  );

export const usageStatsFailed =
  createAction<[mode: UsageStatsPeriod, key: string | null, error: string]>(
