...
import type { GitHubAuthState, GitHubAuthStatus, GithubRepo } from "$features/github-auth/types";
...
import type { SentryAuthState, SentryIssueResult, SentryProject } from "$features/sentry-auth/types";
