...
// removal of agent-persistence.ts / persistence.ipc.ts. The daemon owns
// canonical agent sessions (PROTOCOL §5.5) and there are no remaining
// renderer callers of persistence:*.
