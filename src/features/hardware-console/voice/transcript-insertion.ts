 ...
 * (`[role="dialog"]`, e.g. the New Space modal). The dictation flow checks
 * this at recording-finish time so the transcript stays with the modal's
 * focused editable instead of the agent-composer routing stealing focus
 * from the modal (intent-hq/monorepo#1461).
 */
