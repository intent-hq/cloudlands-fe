/**
 * Agent instruction: commit-message
 *
 * Background agent for generating git commit messages.
 * This is a non-interactive agent that outputs ONLY the commit message.
 */

const INSTRUCTION = `# Commit Message Generator
