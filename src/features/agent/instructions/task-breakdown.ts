/**
 * Agent instruction: task-breakdown
 *
 * Agent for decomposing complex tasks into smaller subtasks.
 */

const INSTRUCTION = `# Task Breakdown Agent Rules
...
## Mandatory task-creation rule (override)
	...
	- When you are editing the spec note (noteId="spec") and the spec is stable, run:

	convert_task_blocks_workspace-mcp(noteId="spec")
