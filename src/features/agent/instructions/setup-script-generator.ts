/**
 * Agent instruction: setup-script-generator
 *
 * Background agent for generating setup scripts for git worktrees.
 * Platform-aware: generates PowerShell instructions on Windows, bash on Mac/Linux.
 */

const INSTRUCTION_BASH = `# Setup Script Generator
...
const INSTRUCTION_POWERSHELL = `# Setup Script Generator
...
// Select the appropriate instruction based on platform
const INSTRUCTION = process.platform === 'win32' ? INSTRUCTION_POWERSHELL : INSTRUCTION_BASH;
