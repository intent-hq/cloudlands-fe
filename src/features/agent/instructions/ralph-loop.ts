/**
 * Agent instruction: ralph-loop
 *
 * Coordinator-style loop agent that plans interactively with the user,
 * then autonomously delegates work and testing in a loop until done.
 */

const INSTRUCTION = `# Ralph Loop Agent
