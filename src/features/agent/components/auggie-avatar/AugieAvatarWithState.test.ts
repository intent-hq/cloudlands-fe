...
vi.mock('./AuggieAvatar.svelte', async () => ({
  default: (await import('$lib/components/agent-overview/__tests__/mocks/MockAuggieAvatar.svelte'))
    .default,
}));
...
warmImport(() => import('$lib/components/agent-overview/__tests__/mocks/MockAuggieAvatar.svelte'));
