...
<span class={cn('inline-flex shrink-0', className)}>
  {#if providerId === 'antigravity'}
    <!-- Official ACP registry icon, antigravity-acp/icon.svg (a3d294f). -->
    <svg
      class={className}
      width={size}
      height={size}
      ...
      ><g transform="translate(30, 0)"
        ><g clip-path="url(#clip0_1401_86274)"
          ><mask
            ...
            y="0"
            width="240"
            height="300"><path d="M240 0H0V300H240V0Z" fill="white" /></mask
        ...
        ></g
      ><defs
        ><clipPath id="clip0_1401_86274"><rect width="240" height="300" fill="white" /></clipPath
        ></defs
      ></svg
    >
