/**
 * Agent instruction: task-loop
 *
 * Agent for task-oriented sessions using a shared markdown note.
 * The Task Note is provided to the agent (not created by the agent).
 */

const INSTRUCTION = `# Task Loop Agent
