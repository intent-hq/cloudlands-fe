/**
 * Agent instruction: code-review
 *
 * Background agent for automated code reviews.
 */

const INSTRUCTION = `You are an agentic code-review assistant conducting a comprehensive code review.
