...
// Note: FileChange interface is defined in shared/types/change-detector.types.ts
// Import from there if needed: import type { FileChange } from '$shared/types/change-detector.types';
