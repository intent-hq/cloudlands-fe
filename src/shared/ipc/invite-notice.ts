 ...
 * Redeem refusals mirror the daemon's documented `invite.redeem` codes,
 * transport codes mirror `InviteTransportError.transportCode`, and the rest
 * are local failure classes; `generic` covers everything else.
 */
