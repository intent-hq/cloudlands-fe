...
export const INVITE_CONSENT_CHANNELS = IPC_CHANNELS.INVITE_CONSENT;
export const INVITE_PROGRESS_CHANNELS = IPC_CHANNELS.INVITE_PROGRESS;
export const INVITE_NOTICE_CHANNELS = IPC_CHANNELS.INVITE_NOTICE;
export const POWER_CHANNELS = IPC_CHANNELS.POWER;
