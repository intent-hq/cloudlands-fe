...
export const NOTES_CHANNELS = IPC_CHANNELS.NOTES;
export const ASSETS_CHANNELS = IPC_CHANNELS.ASSETS;
export const EVENTS_CHANNELS = IPC_CHANNELS.EVENTS;
export const OBSERVABILITY_CHANNELS = IPC_CHANNELS.OBSERVABILITY;
...
export const PERSISTENCE_CHANNELS = IPC_CHANNELS.PERSISTENCE;
...
export const LINE_ATTRIBUTION_CHANNELS = IPC_CHANNELS.LINE_ATTRIBUTION;
export const COMMENTS_CHANNELS = IPC_CHANNELS.COMMENTS;
export const FILE_TRACKING_CHANNELS = IPC_CHANNELS.FILE_TRACKING;
export const LOG_CHANNELS = IPC_CHANNELS.LOG;
export const MCP_CHANNELS = IPC_CHANNELS.MCP;
...
export const LINE_CHANGES_CHANNELS = IPC_CHANNELS.LINE_CHANGES;
export const REMOTE_FS_CHANNELS = IPC_CHANNELS.REMOTE_FS;
export const TESTING_CHANNELS = IPC_CHANNELS.TESTING;
...
export const EDITOR_INTEGRATION_CHANNELS = IPC_CHANNELS.EDITOR_INTEGRATION;
...
export const REPO_CONFIG_CHANNELS = IPC_CHANNELS.REPO_CONFIG;
...
export const SESSION_STATS_CHANNELS = IPC_CHANNELS.SESSION_STATS;
