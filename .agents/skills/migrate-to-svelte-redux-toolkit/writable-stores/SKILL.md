---
name: migrate-to-svelte-redux-toolkit/writable-stores
description: >-
...
> `skills/migrate-to-svelte-redux-toolkit/derived-stores/SKILL.md`.
...
import { createCollection, upsertItem, type Collection } from "svelte-redux-toolkit/utils/collections/collection-utils";
import { createAction } from "svelte-redux-toolkit/utils/store/create-action";
import { createReducer } from "svelte-redux-toolkit/utils/store/create-reducer";
...
`skills/migrate-to-svelte-redux-toolkit/side-effects/SKILL.md`.

## Cross-References

- `skills/svelte-redux-toolkit/actions/SKILL.md` — full `createAction` surface
- `skills/svelte-redux-toolkit/reducers/SKILL.md` — full `createReducer` surface (no-op reference-equality)
- `skills/svelte-redux-toolkit/state-serialization/SKILL.md` — serializable state rules
