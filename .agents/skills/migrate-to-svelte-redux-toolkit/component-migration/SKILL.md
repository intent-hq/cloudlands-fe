---
name: migrate-to-svelte-redux-toolkit/component-migration
description: >-
...
- `skills/svelte-redux-toolkit/component-integration/SKILL.md` — Store init,
  Store dispatch, `$selectorResult$` template rules
- `skills/svelte-redux-toolkit/selector-lifecycle/SKILL.md` — three call modes
