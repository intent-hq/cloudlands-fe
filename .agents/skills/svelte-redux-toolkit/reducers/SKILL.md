---
name: svelte-redux-toolkit/reducers
description: >-
...
> Operational guidance for reducer implementation. Full API walkthrough and examples: `docs/REDUCERS.md` → Creating Reducers. Source: `src/utils/store/create-reducer.ts` and `skills/svelte-redux-toolkit/SKILL.md` §3, §14.
...
```ts
import { type Collection, createCollection, updateItem } from "svelte-redux-toolkit/utils/collections/collection-utils";
import { createAction } from "svelte-redux-toolkit/utils/store/create-action";
import { createReducer } from "svelte-redux-toolkit/utils/store/create-reducer";
...
- `svelte-redux-toolkit/actions/SKILL.md` — action creator contracts consumed by `.with()`.
- `svelte-redux-toolkit/collections/SKILL.md` — immutable entity updates.
- `svelte-redux-toolkit/selectors/SKILL.md` — derived values belong in selectors.
- `svelte-redux-toolkit/state-serialization/SKILL.md` — serializable state rules.
- `svelte-redux-toolkit/testing/SKILL.md` — reducer test expectations.