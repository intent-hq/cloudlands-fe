---
name: svelte-redux-toolkit/selector-lifecycle
description: >-
  The three selector call modes and Store-first dispatch rule — the #1
  source of runtime crashes in svelte-redux-toolkit. Covers selectFoo() at
...
> Operational checklist for avoiding `lifecycle_outside_component`. Human reference and examples: `docs/SELECTORS.md` → Using Selectors and Selector Lifecycle Rules. Source: `skills/svelte-redux-toolkit/SKILL.md` §4, §7.
...
- `svelte-redux-toolkit/selectors/SKILL.md` — selector authoring and composition.
- `svelte-redux-toolkit/component-integration/SKILL.md` — component store/dispatch wiring.
- `svelte-redux-toolkit/selector-channels/SKILL.md` — selector reads from sagas.
- `svelte-redux-toolkit/waitFor/SKILL.md` — saga waiting on selector predicates.