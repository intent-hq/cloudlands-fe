---
name: svelte-redux-toolkit/collections
description: >-
  ...
  (or the same reference on a no-op). Source: docs/COLLECTIONS.md,
...
sources:
  - augmentcode/svelte-redux-toolkit:docs/COLLECTIONS.md
  - augmentcode/svelte-redux-toolkit:src/utils/collections/collection-utils.ts
triggers:
  - create collection
  - addItem collection
  - upsert item
...
> Operational guidance for normalized entity state. Full API reference and examples: `docs/COLLECTIONS.md`. Source: `src/utils/collections/collection-utils.ts`.
...
- Import helpers from `svelte-redux-toolkit/utils/collections/collection-utils`.
...
```ts
import { type Collection, createCollection } from "svelte-redux-toolkit/utils/collections/collection-utils";
...
```ts
import { addItem, createCollection, removeItem, updateItem, upsertItem } from "svelte-redux-toolkit/utils/collections/collection-utils";
...
```ts
import { addItemAndCountRef, createCollection, decreaseRefsCount, getRefsCount } from "svelte-redux-toolkit/utils/collections/collection-utils";
...
import { type Collection, createCollection, getItem, getItems } from "svelte-redux-toolkit/utils/collections/collection-utils";
...
- `svelte-redux-toolkit/reducers/SKILL.md` — pure immutable reducer updates.
- `svelte-redux-toolkit/selectors/SKILL.md` — collection selector helpers.
- `svelte-redux-toolkit/state-serialization/SKILL.md` — collections as serializable alternatives to `Map`/`Set`.