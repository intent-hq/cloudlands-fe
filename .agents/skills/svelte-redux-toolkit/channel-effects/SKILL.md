---
name: svelte-redux-toolkit/channel-effects
description: >-
...
Source: redux-saga channel watcher effects, `skills/svelte-redux-toolkit/SKILL.md §5 (Channel Effects)`.
...
Source: `src/slices/store-utility/sagas`. Priority: **MEDIUM**.

## See also

- `svelte-redux-toolkit/selector-channels` — for selector-derived channels (the right tool for state changes).
- `svelte-redux-toolkit/sagas` — core saga patterns, `takeEvery` / `takeLatest` for actions.
