---
name: svelte-redux-toolkit/state-serialization
description: >-
...
> Operational checklist for reducer state shape. Full rationale and examples: `docs/REDUCERS.md` → State Serialization Rules. Source: `src/utils/store/create-reducer.ts` consumers and `skills/svelte-redux-toolkit/SKILL.md` §12.
...
- `svelte-redux-toolkit/reducers/SKILL.md` — reducer purity and same-reference no-op behavior.
- `svelte-redux-toolkit/collections/SKILL.md` — serializable normalized entity storage.
- `svelte-redux-toolkit/state-integrity/SKILL.md` — derived values and canonical ownership.