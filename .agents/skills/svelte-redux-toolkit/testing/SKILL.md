---
name: svelte-redux-toolkit/testing
description: >-
  ...
  docs/TESTING.md, skills/svelte-redux-toolkit/SKILL.md §14.
type: sub-skill
...
sources:
  - augmentcode/svelte-redux-toolkit:docs/TESTING.md
...
> Operational testing checklist. Human-facing examples: `docs/TESTING.md`. Saga effect details: `svelte-redux-toolkit/sagas/SKILL.md`. Source: `skills/svelte-redux-toolkit/SKILL.md` §14.
...
import { createAction, createAsyncAction } from "svelte-redux-toolkit/utils/store/create-action";
...
- Run architecture validation for state/actions/selectors/sagas changes when in scope: `npm run validate:architecture` in this repository, or `npx svelte-redux-toolkit validate-architecture` / `npm exec svelte-redux-toolkit -- validate-architecture` in a consuming app.
- Run skill-example validation after changing docs/skills examples: `npm run validate:skill-examples` in this repository, or `npx svelte-redux-toolkit validate-skill-examples` / `npm exec svelte-redux-toolkit -- validate-skill-examples` in a consuming app.
...
- `svelte-redux-toolkit/reducers/SKILL.md` — reducer purity and reference equality.
- `svelte-redux-toolkit/selectors/SKILL.md` — `.select(state)` selector testing.
- `svelte-redux-toolkit/sagas/SKILL.md` — saga effect and watcher conventions.
- `svelte-redux-toolkit/state-integrity/SKILL.md` — canonical ownership evidence.