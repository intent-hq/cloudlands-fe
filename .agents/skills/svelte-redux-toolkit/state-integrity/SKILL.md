---
name: svelte-redux-toolkit/state-integrity
description: >-
...
> `npm exec svelte-redux-toolkit -- validate-architecture` in a consuming app.
...
inside this repository; use `npx svelte-redux-toolkit validate-architecture` or
`npm exec svelte-redux-toolkit -- validate-architecture` in a consuming app.
...
- `svelte-redux-toolkit/core-policy` — always-on Redux ownership rules.
- `svelte-redux-toolkit/collections` — canonical entity storage.
- `svelte-redux-toolkit/selectors` — where derived values belong.
- `svelte-redux-toolkit/verifier` — review gates for these rules.