---
name: svelte-redux-toolkit/actions
description: >-
...
> Operational guidance for action creator work. API details and longer examples live in `docs/REDUCERS.md` → Actions and Async Actions. Source: `src/utils/store/create-action.ts` and `skills/svelte-redux-toolkit/SKILL.md` §3.
...
- `svelte-redux-toolkit/reducers/SKILL.md` — consuming actions in `.with()` handlers.
- `svelte-redux-toolkit/sagas/SKILL.md` — watcher patterns and typed-redux-saga usage.
- `svelte-redux-toolkit/state-integrity/SKILL.md` — duplicate-owner search protocol.
- `svelte-redux-toolkit/file-structure/SKILL.md` — where action creators belong.