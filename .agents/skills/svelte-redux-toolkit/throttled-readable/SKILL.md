---
name: svelte-redux-toolkit/throttled-readable
description: >-
  Public guidance for selector emission coalescing after Store-first export
  pruning. Selector scheduler helpers are internal details and must not be
...
- Do not import `src/utils/selectors/selector-scheduler` from app code.
...
- `svelte-redux-toolkit/selectors` — building Store-bound selectors.
