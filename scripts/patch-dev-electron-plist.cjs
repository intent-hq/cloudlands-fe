...
execFileSync('plutil', ['-insert', PLIST_KEY, '-string', USAGE_DESCRIPTION, plistPath], {
  stdio: 'inherit',
});
...
try {
  ...
  console.warn('Warning: ad-hoc re-sign of dev Electron failed after plist patch; continuing.');
}
