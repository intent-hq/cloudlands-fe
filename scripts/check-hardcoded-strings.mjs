...
const ENFORCED_DIRS = [
  ...
  // chat batch: A–L components + input/ subdirectory (chat/ is only partially
  // migrated, so files are listed individually)
  'src/lib/components/chat/input',
  ...
  'src/lib/components/chat/AgentMessageList.svelte',
  'src/lib/components/chat/AgentPreviewToolLabel.svelte',
  'src/lib/components/chat/AgentsList.svelte',
  'src/lib/components/chat/AgentSubscriptions.svelte',
  'src/lib/components/chat/AnimatedStreamingText.svelte',
  'src/lib/components/chat/AttachmentPreview.svelte',
  'src/lib/components/chat/AuroraBackground.svelte',
  ...
  'src/lib/components/chat/ChatFileChangesSummary.svelte',
  ...
  'src/lib/components/chat/ChatWorkspaceCard.svelte',
  'src/lib/components/chat/ChiefChatEmptyState.svelte',
  'src/lib/components/chat/CombinedInlineDiffItem.svelte',
  'src/lib/components/chat/ContextChip.svelte',
  'src/lib/components/chat/ContextEngineToolCall.svelte',
  'src/lib/components/chat/CylinderScroller.svelte',
  'src/lib/components/chat/DateSeparator.svelte',
  'src/lib/components/chat/DetectedScriptsCard.svelte',
  'src/lib/components/chat/DiffViewer.svelte',
  'src/lib/components/chat/DigestCard.svelte',
  'src/lib/components/chat/EditRegenerateConfirmDialog.svelte',
  'src/lib/components/chat/EventWakeupBanner.svelte',
  'src/lib/components/chat/event-wake-summary.ts',
  'src/lib/components/chat/InlineAgentAvatar.svelte',
  'src/lib/components/chat/InlineDiffItem.svelte',
  'src/lib/components/chat/InlinePermissionRequest.svelte',
  'src/lib/components/chat/InterruptionNotice.svelte',
  'src/lib/components/chat/LazyTurn.svelte',
